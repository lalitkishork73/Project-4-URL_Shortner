...
This application is based on URL. it takes Long URL and returns Short URL.

<br/>


## Before Run
Before run this App Follow few Steps and always remember run all commands in main directory. if you try to run this commands in client and server directory it will not work.
1. Install node_module in main folder using Command 
### `npm install`
2. Install Client and Server dependencies or node_modules using command 
### `npm run depi`
3. After the installation of all dependencies run client and server using command

### `npm start`
4. Aftee running this commands both client and server start together and then you will be able to use app.
